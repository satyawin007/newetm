							...
							<div class="panel-body">
								<div class="col-xs-6">
									<div class="form-group">
										...
										<div class="col-xs-8">
											<input type="text" id="fullname" value="{{$employee->fullName}}" name="fullname" class="form-control">
										</div>
									</div>
									<div class="form-group">
								...
								<div class="col-xs-6">
									<div class="form-group">
										...
										<div class="col-xs-8">
											<select class="form-control" name="designation">
												...
												<option value="Area Superviser">Area Superviser</option>
											</select>
										</div>
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										...
										<div class="col-xs-8">
											<select class="form-control" name="officebranch">
											</select>
										</div>
									</div>
									<div class="form-group">
										<label class="col-xs-4 control-label no-padding-right" for="form-field-1"> CLient/Own<span style="color:red;">*</span> </label>
										<div class="col-xs-8">
											<select class="form-control" name="client_own">
											</select>
										</div>
									</div>
									<div class="form-group">
