...
class VehicleController extends \Controller {
	...
	public function addVehicle()
	{
		...
		$form_fields[] = $form_field;
		$form_field = array("name"=>"monthlyemi", "content"=>"monthly emi", "readonly"=>"",  "required"=>"required","type"=>"text", "class"=>"form-control");
		$form_fields[] = $form_field;
	...
	public function editVehicle()
	{
		...
		$form_fields[] = $form_field;
		$form_field = array("name"=>"monthlyemi", "value"=>$entity->emi,  "content"=>"monthly emi", "readonly"=>"",  "required"=>"required","type"=>"text", "class"=>"form-control");
		$form_fields[] = $form_field;
