...
class CreditSupplierController extends \Controller {
	...
	public function editCreditSupplier()
	{
		...
		if(count($entity)){
			...
			$form_fields[] = $form_field;
			$form_field = array("name"=>"paymenttype", "id"=>"paymenttype", "value"=>$entity->paymentType, "content"=>"payment type", "readonly"=>"",  "required"=>"required", "type"=>"select", "class"=>"form-control", "options"=>$type_arr);
			$form_fields[] = $form_field;
	...
	public function manageCreditSupplier()
	{
		...
		$form_fields[] = $form_field;
		$form_field = array("name"=>"paymenttype", "content"=>"payment type", "readonly"=>"",  "required"=>"required", "type"=>"select", "class"=>"form-control chosen-select", "options"=>$type_arr);
		$form_fields[] = $form_field;
